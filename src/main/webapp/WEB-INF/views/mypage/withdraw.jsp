    ...
    $(document).ready(function () {
      ...
      $(document).on("click", function (e) {
        ...
        if (
          ...
          $("#withdrawErrorMessage2").removeClass("visible");
        }
      });
      ...
      function pwUpdate(f3) {
        ...
        if (userPw === "") {
          ...
          $("#withdrawErrorMessage1").text("새로운 비밀번호를 입력하세요.").addClass("visible");
          setTimeout(() => {
            $("#withdrawErrorMessage1").removeClass("visible");
          }, 2000);
          $("#userPw").focus();
        ...
        if (pwCheck === "") {
          ...
          $("#withdrawErrorMessage1").text("검증을 위한 새로운 비밀번호를 입력하세요.").addClass("visible");
          setTimeout(() => {
            $("#withdrawErrorMessage1").removeClass("visible");
          }, 2000);
          $("#pwCheck").focus();
...
<%--    <div id="withdrawErrorMessage2" class="error-message"></div>--%>
